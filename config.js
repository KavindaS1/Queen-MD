...
global.ownername = process.env.OWNER_NAME === undefined ? "KAVINDA BOT" : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '94720883381' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
...
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? 'KAVINDA BOT' : process.env.STICKER_AUTHOR_NAME
